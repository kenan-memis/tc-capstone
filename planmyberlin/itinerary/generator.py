...
from planmyberlin.itinerary.place_policy import apply_unique_place_policy, merge_retrieval_candidates
...
def generate_itinerary(state: dict[str, Any]) -> dict[str, Any]:
    ...
    candidates = merge_retrieval_candidates(state)
    ...
    if not os.getenv("OPENAI_API_KEY"):
        ...
        it = apply_unique_place_policy(
            it,
            profile=profile,
            candidates=candidates,
            weather_bias=str(state.get("weather_bias", "")),
        )
